...
const users = {
  ...
  login_user: async (username, password) => {
    ...
    return {
      ...
      monthly_budget: user.monthly_budget ?? 3500.0,
    };
  },

  update_monthly_budget: async (user_id, monthly_budget) => {
    user_id = user_id.trim();
    validate.misc.object_id(user_id);
    validate.users.monthly_budget(monthly_budget);
